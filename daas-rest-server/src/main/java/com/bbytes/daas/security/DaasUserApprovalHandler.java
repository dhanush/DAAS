...
public class DaasUserApprovalHandler extends TokenServicesUserApprovalHandler {
	...
	public boolean isApproved(AuthorizationRequest authorizationRequest, Authentication userAuthentication) {
		...
		String flag = authorizationRequest.getApprovalParameters().get("user_oauth_approval");
